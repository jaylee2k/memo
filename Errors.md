...
| 2026-02-08 | App / XAML | `Button.Content` 중복 설정으로 `StickyNoteWindow` 빌드 실패 | `StickyNoteWindow.xaml` 툴바 버튼 Content 선언 정리 |

## Notes
- Keep this file focused on runtime/build errors that required a code-level fix.
